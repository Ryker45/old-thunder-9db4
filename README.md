...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/old-thunder-9db4
```

A live public deployment of this template is available at [https://old-thunder-9db4.templates.workers.dev](https://old-thunder-9db4.templates.workers.dev)
